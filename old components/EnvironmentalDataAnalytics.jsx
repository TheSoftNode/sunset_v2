        ...
        <div className='basis-2/3 mb-3 p-3'>
          ...
          <div className='pl-12'>
            <input
              ...
              placeholder="eircode"
              aria-label=''
              className={`peer w-64  block w-full py-3 px-3 text-gray-600 bg-white border border-gray-400 focus:border-blue-400 focus:outline-none focus:ring-0 appearance-none rounded-lg transition-colors duration-300`}    
            />
          </div>
          <div className='p-5 '>
          ...
          <div className="relative w-full lg:max-w-sm pl-12">
            <select className="peer w-64 block w-full py-3 px-3 text-gray-600 bg-white border border-gray-400 focus:border-blue-400 focus:outline-none focus:ring-0 appearance-none rounded-lg transition-colors duration-300">
                <option>1 Day</option>
          ...
          <div className='text-end'>
            <MDBBtn className='me-1 p-2 w-40 hover:bg-blue-500 border-color:bg-blue-500' color='success'>
              Analyse
            </MDBBtn>
          </div> 
        </div>
